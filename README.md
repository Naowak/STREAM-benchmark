...
| chaotic_forecasting | **20.106** | 38.106 | 658.972 | - | - || 247.040 | 218.270 | 172.075 | **147.606** | 155.414 || - | 225.875 | 191.740 | **185.512** | - ||
| adding_problem | 1.000 | 0.990 | **0.960** | - | - || - | **1.000** | **1.000** | **1.000** | **1.000** || - | 1.000 | 0.990 | **0.985** | - ||
| sin_forecasting | 0.005 | **0.003** | 0.004 | - | - || 0.302 | 0.046 | 0.027 | 0.019 | **0.018** || - | 0.030 | **0.027** | 0.027 | - ||
| bracket_matching | 0.125 | 0.120 | **0.110** | - | - || **0.430** | **0.430** | **0.430** | **0.430** | **0.430** || - | 0.430 | **0.320** | 0.350 | - ||
| continue_postcasting | 0.010 | 0.001 | **0.001** | - | - || 0.201 | 0.160 | 0.130 | 0.102 | **0.090** || - | 0.198 | **0.197** | 0.197 | - ||
| discrete_pattern_completion | **0.200** | **0.200** | **0.200** | - | - || - | 0.363 | 0.220 | 0.203 | **0.199** || - | **0.200** | **0.200** | **0.200** | - ||
| mnist_classification | 0.555 | **0.220** | 0.255 | - | - || - | **1.000** | **1.000** | **1.000** | **1.000** || - | 0.890 | **0.840** | **0.840** | - ||
