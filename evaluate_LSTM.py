...
if __name__ == "__main__":
    ...
    benchmark = Benchmark(model_class=LSTM, model_name="LSTM-test", seeds=seeds)
    n_trials = N_TRIALS
    model_args = {"hidden_size": [10, 100], "num_layers": [1, 10], "learning_rate": 1e-3}
    training_args = {"epochs": 10, "batch_size": 10}
